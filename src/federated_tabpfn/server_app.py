...
from .dataset_pilot import _create_model, _dataset_state, _get_model_parameters
    ...
    if scenario == "smoke":
        ...
        payload = {
            ...
            **resource_usage,
            ...
            "history": _result_to_history_dict(result),
            "notes": [
                "This is the first dataset-backed baseline slice using Flower's Message API launched via flwr run.",
                "It uses the Adult engineering slice and federated logistic regression under Flower.",
            ],
        }
